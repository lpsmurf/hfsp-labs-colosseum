...
export type AgentId = 'price-monitor' | 'portfolio-analyzer' | 'sentiment-monitor' | 'trending-agent' | 'prediction-markets-agent' | 'news-digest-agent' | 'crypto-news-digest' | 'x402-audit-api';
