...
interface Props {
  /** Optional email to link with the wallet (for trial combo tracking) */
  email?: string;
  /** Label override */
  label?: string;
...
export default function PhantomWalletButton({ email, label, onError }: Props) {
  ...
  return (
    <button
      ...
      disabled={loading}
      className="w-full flex items-center justify-center gap-3 bg-purple-600 text-white py-2 rounded-md font-medium hover:bg-purple-700 disabled:opacity-50 transition-colors"
    >
      {/* Phantom ghost logo SVG */}
      <svg width="20" height="20" viewBox="0 0 128 128" fill="none" xmlns="http://www.w3.org/2000/svg">
        <rect width="128" height="128" rx="64" fill="white" fillOpacity="0.2"/>
        <path d="M110.584 64.9142H99.142C99.142 41.8335 80.29 23 57.19 23C34.372 23 15.7 41.4747 15.416 64.2515C15.1153 88.0908 36.842 108 60.7 108H65.262C85.498 108 113.764 93.0662 117.986 72.5264C118.624 69.3947 116.094 64.9142 110.584 64.9142Z" fill="white"/>
        <ellipse cx="49.806" cy="64.9145" rx="6.524" ry="6.508" fill="#AB9FF2"/>
        <ellipse cx="73.958" cy="64.9145" rx="6.524" ry="6.508" fill="#AB9FF2"/>
      </svg>
      {stepLabel}
    </button>
  );
